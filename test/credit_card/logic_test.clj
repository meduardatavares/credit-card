            ...
            :cartao {:numero             5274639975504476
                     ...
                     :compras-realizadas [{:id              :compra1
                                          ...
                                          {:id              :compra3
                                           ...
                                           :categoria       "Alimentação"}
                                          {:id              :compra4
                                           :data            (time/local-date 2021 9 10)
                                           :valor           200.0
...
(def mock3 {:nome   "vanessa"
            ...
            :cartao {:numero             5274639975504476
                     ...
                     :limite             1000
                     :compras-realizadas [{:id              :compra1,
                                           :data            (time/local-date 2029 05 18)
                                           :valor           50.0,
                                           :estabelecimento "ABC",
                                           :categoria       "Alimentação"}]}})
...
(deftest compras-por-estabelecimento-test
  (testing "compras por estabelecimento"
    (is (= [] (compras-por-estabelecimento mock3 "Colegio")))
    (is (= [{:id :compra1, :data (time/local-date 2021 01 01), :valor 50.0, :estabelecimento "ABC", :categoria "Alimentação"}] (compras-por-estabelecimento mock1 "ABC")))
    (is (= [{:id              :compra4
             :data            (time/local-date 2021 01 22)
             :valor           200.0
             :estabelecimento "Curso wizard"
...
(deftest adiciona-compra-test
  (testing "Retorna lista com novas compras"
    (is (= [{:id              :compra1
             ...
             :valor           250.0
             :estabelecimento "Curso wizard"
             :categoria       "Alimentação"}] (adiciona-compra mock2 {:id              :compra1
                                                                      :data            (time/local-date 2021 10 10)
                                                                      :valor           250.0
                                                                      :estabelecimento "Curso wizard"
                                                                      :categoria       "Alimentação"}))))
  (testing "retorna a quantidade mais um de compras"
    (is (= (+ (count (:compras-realizadas (:cartao mock1))) 1)
           (count (adiciona-compra mock1 {:id              :compra1
                                          :data            (time/local-date 2021 10 10)
                                          :valor           250.0
                                          :estabelecimento "Curso wizard"
                                          :categoria       "Alimentação"}))))))
